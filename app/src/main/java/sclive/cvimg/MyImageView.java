...
public class MyImageView extends ImageView implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener {
    ...
    public MyImageView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     public void MyInit(int w,int h){
         Log.d("zb","MyInit w "+w + "h "+h);
         mDrawableWidth=w;
         mDrawableHeight=h;
         initImageViewSize();
         moveToCenter();
    ...
    private void initListener() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mWidth = getWidth();
                mHeight = getHeight();
                Log.d("zb","#####控件 w "+mWidth+" h "+mHeight);
...
//            return;
        ...
        Log.d("zb","### mScale "+ mScale+ "max "+mMaxScale+"min "+mMinScale);
    }
